...
public class Module {
	...
	public static final String ALIAS_PARENT = "父模块";
	public static final String ALIAS_NAME = "名称";
	public static final String ALIAS_ICON = "图标";
	public static final String ALIAS_EXPANDED = "是否展开";
	public static final String ALIAS_TYPE = "类型 1菜单 2功能";
	public static final String ALIAS_PERMISSION = "权限query edit delete";
	public static final String ALIAS_ORDER = "排序";
    ...
    /**
     * 是否展开       db_column: expanded 
     */	
	private java.lang.String expanded;
    /**
     * 类型 1菜单 2功能       db_column: type 
     */	
	private java.lang.Integer type;
    /**
     * 权限query edit delete       db_column: permission 
     */	
