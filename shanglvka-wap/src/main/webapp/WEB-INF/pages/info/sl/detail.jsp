...
<body >
	<div>
		<article class="content_detail">
			<div style="background-image: url('${merchantMap.bgPic}');margin: auto; vertical-align: middle" width="100%">
			${merchantMap.title}<br>
			${merchantMap.address}
			</div>
			...
			<div class="list border_bottom1">
				...
				<span class="words06">${merchantMap.area.name}</span>
				<span class="floatR BTN02"><img src="${ctx}/static/img/info/icon06.png" height="20" align="left"/><a href="#">查看地图</a></span>
			</div>
			<div class="list border_bottom1"><span class="words07 margin_L20">折扣优惠：</span><span class="words06">${merchantMap.offer}</span></div>
			<div class="list">
